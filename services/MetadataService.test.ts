...
describe('MetadataService', () => {
    ...
    describe('getPhotoMetadata', () => {
        it('extracts dimensions and date from EXIF', async () => {
            ...
            // Mock fileToDataURL
            vi.spyOn(MetadataService as any, 'fileToDataURL').mockResolvedValue('data:image/jpeg;base64,...');
        ...
        it('handles GPS coordinate conversion', async () => {
            ...
            vi.mocked(piexif.load).mockReturnValue({
                ...
                "Exif": {},
                "GPS": {
                    [piexif.GPSIFD.GPSLatitude]: [[45, 1], [30, 1], [0, 1]], // 45°30'0"
                    [piexif.GPSIFD.GPSLatitudeRef]: "N",
                    [piexif.GPSIFD.GPSLongitude]: [[9, 1], [10, 1], [0, 1]], // 9°10'0"
    ...
    describe('getVideoMetadata', () => {
        it('extracts duration and calculates bitrate', async () => {
            ...
            vi.spyOn(MetadataService as any, 'getMp4CreationTime').mockResolvedValue(new Date(2024, 0, 1));
