...
export const Home: React.FC<HomeProps> = ({ onSelectTool }) => {
  ...
  return (
    <div className="h-full overflow-y-auto bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-slate-800 via-slate-900 to-slate-950 scroll-smooth">
      <div className="min-h-full flex flex-col items-center py-12 px-6 md:px-8">
        <div className="my-auto w-full flex flex-col items-center">
          <div className="max-w-4xl w-full text-center mb-12 animate-fadeIn">
            <div className="flex justify-center mb-8">
              <LanguageSwitcher />
            </div>
            <h1 className="text-4xl md:text-6xl font-black mb-6 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent leading-tight">
              {t.home.title}
            </h1>
            <p className="text-lg md:text-xl text-slate-400 max-w-4xl mx-auto mb-10 lg:whitespace-nowrap">
              {t.home.subtitle}
            </p>
          </div>
          ...
          <div className="mt-12 mb-8 flex flex-col items-center gap-2 text-slate-500 text-xs italic">
